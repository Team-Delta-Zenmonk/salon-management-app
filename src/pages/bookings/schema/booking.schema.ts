...
export const bookingSchema = z.object({
  customer_name: z.string({ message: "Required" }).min(1, { message: "Required" }),
  customer_phone: z.string({ message: "Required" }).min(10, { message: "Phone number must be at least 10 digits" }),
